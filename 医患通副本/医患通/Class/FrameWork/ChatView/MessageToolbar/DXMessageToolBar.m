...
//    _inputTextView.placeHolder = NSLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    _inputTextView.placeHolder = @"发送消息";
    ...
    [self.recordButton setTitle:@"发送语音" forState:UIControlStateNormal];
    [self.recordButton setTitle:@"发送结束" forState:UIControlStateHighlighted];
